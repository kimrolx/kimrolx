...
export function TypewriterGreeting() {
  ...
  return (
    <p className="flex items-center gap-1 text-lg font-medium text-ink-2 sm:text-xl">
...
export function RoleLine() {
  const text = useTypewriter(profile.roles, { typingSpeed: 55, pauseAfterComplete: 1900 });
