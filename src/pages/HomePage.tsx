...
export default function HomePage() {
  ...
  return (
    <div className="max-w-3xl centered flex-col gap-10 m-auto">
      {/* Introduction */}
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-row items-center justify-center gap-5 mt-8">
          <Button onClick={onViewWorkClick} className=" text-inherit hover:bg-black hover:cursor-pointer transition">
            View my work
          </Button>
          <Button
