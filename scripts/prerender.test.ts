...
<link rel="canonical" href="https://www.kimrolx.com/" />
<meta property="og:title" content="OLD OG TITLE" />
<meta property="og:description" content="OLD OG DESC" />
<meta property="og:url" content="https://www.kimrolx.com/" />
...
const M = {
  ...
  canonical: 'https://www.kimrolx.com/now',
...
test('rewrites canonical and og:url to route path', () => {
  const out = rewriteMeta(SAMPLE, M);
  assert.match(out, /rel="canonical" href="https:\/\/www\.kimrolx\.com\/now"/);
  assert.match(out, /property="og:url" content="https:\/\/www\.kimrolx\.com\/now"/);
});
